                    ...
                    <form action="{{route('staff.create')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label for="username">Username <span class="input-mandatory">*</span></label>
                                  <input type="username" name="username" value ="{{old('username')}}" class="form-control" id="username" placeholder="Enter username">
                                ...
                                <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">Email address <span class="input-mandatory">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contactno" value ="{{old('contactno')}}" class="form-control" id="exampleInputPassword1" placeholder="Enter contactno">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="position">Position <span class="input-mandatory">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="status">Status <span class="input-mandatory">*</span> </label>
                                      ...
                                      @endif
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                              <label for="status">Upload file <span class="input-mandatory">*</span> </label>
